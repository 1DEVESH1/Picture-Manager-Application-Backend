# Picture-Manager-Application-Backend
...
- **Frontend** part can be found [here](https://github.com/1DEVESH1/Picture-Manager-Application-Frontend)
...
```
npm i @tensorflow/tfjs-node@4.20.0
```
